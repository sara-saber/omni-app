...
const Footer = () => {
    return (
        <Grid>
            ...
            <Grid
                backgroundColor={'#27325E'} container mt={2} pb={{ md: 3, xs: 1 }} pt={{ md: 12, xs: 5 }} px={{ md: 22, xs: 2 }} rowGap={{md:2,xs:5}} columnGap={{md:11}} >
                <Grid lg={12} md={12}>
                ...
                <Grid container rowGap={2} md={12} lg={8} sx={{'.css-1p823my-MuiListItem-root':{
                    pl:0
                }}} >
